    ...
    <div class="box_padding_all">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-home"></i> <a href="<?php echo site_url('Admin'); ?>">Home</a> / <a href="<?php echo site_url('Admin/brands'); ?>">Vendors</a> / Update Vendor's Details</h3>
            </div>
        </div>
                ...
                <div class="x_panel container-space">
                    ...
                    <div class="col-sm-12 x_content div_pad_12">
                    	<div class="header-bottom-border">
                        	<i class="fa fa-download"></i> Update Vendor Details
                        </div>
                        <div class="content_body">
							...
							<?php echo form_open_multipart('Admin/edit_brand/'.$brand_details->vendor_id, $attributes); ?>
                            <!--<form class="form-horizontal" role="form">-->
                                <div class="form-group">
                                	<label class="control-label col-sm-1" for="email">Name:</label>
                                    <div class="col-sm-11">
                                    	<input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="Enter Brand Name" value="<?php echo $brand_details->vendor_name; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                	<label class="control-label col-sm-1" for="email">Address:</label>
                                    <div class="col-sm-11">
                                    	<input type="text" class="form-control" name="brand_address" id="brand_address" placeholder="Enter Brand Address" value="<?php echo $brand_details->vendor_address; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                	<label class="control-label col-sm-1" for="pwd">Niche:</label>
                                    <div class="col-sm-11">          
                                    	<input type="text" class="form-control" name="brand_niche" id="brand_niche" placeholder="Enter Brand Niche" value="<?php echo $brand_details->vendor_niche; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                	<label class="control-label col-sm-1" for="pwd">Description:</label>
                                    <div class="col-sm-11">    
                                    	<textarea class="form-control" name="brand_bio" id="brand_bio" placeholder"Enter Brand Description"><?php echo $brand_details->vendor_bio; ?>"</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                	<label class="control-label col-sm-1" for="pwd">Logo:</label>
                                    <div class="col-sm-11"> 
                                    	   <input type="hidden" name="hidden_brand_logo" id="hidden_brand_logo" value="<?php echo $brand_details->vendor_logo; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">    
                                    	<input type="hidden" name="hidden_brand_banner" id="hidden_brand_banner" value="<?php echo $brand_details->vendor_banner; ?>">
                                ...
                                <div class="form-group">        
                                    <div class="col-sm-offset-1 col-sm-11">
                                    	<button type="submit" class="btn btn-success">Edit Vendor <i class="fa fa-download"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
